...
- Official implementation of Carlini et al. (2020): [ftramer/LM_Memorization](https://github.com/ftramer/LM_Memorization)
- Paper: [Extracting Training Data from Large Language Models](https://arxiv.org/abs/2012.07805)

It is a re-implementation that borrows and refactors parts of the official code while adding additional experiments.
